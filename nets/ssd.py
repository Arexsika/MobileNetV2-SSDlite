...
#                                                             net['conv9_2_mbox_conf_flat']])
    ...
    # 对feat1的通道进行l2标准化处理 
    # 32,32,96
    net['feat1_norm'] = Normalize(20, name='feat1_norm')(net['feat1'])
    num_priors = 4
    # 预测框的处理
    # num_priors表示每个网格点先验框的数量，4是x,y,h,w的调整
    net['feat1_norm_mbox_loc']        = Conv2D(num_priors * 4, kernel_size=(3,3), padding='same', name='feat1_norm_mbox_loc')(net['feat1_norm'])
    net['feat1_norm_mbox_loc_flat']   = Flatten(name='feat1_norm_mbox_loc_flat')(net['feat1_norm_mbox_loc'])
    # num_priors表示每个网格点先验框的数量，num_classes是所分的类
    net['feat1_norm_mbox_conf']       = Conv2D(num_priors * num_classes, kernel_size=(3,3), padding='same',name='feat1_norm_mbox_conf')(net['feat1_norm'])
    net['feat1_norm_mbox_conf_flat']  = Flatten(name='feat1_norm_mbox_conf_flat')(net['feat1_norm_mbox_conf'])
    ...
    # 预测框的处理
    # num_priors表示每个网格点先验框的数量，4是x,y,h,w的调整
    net['feat2_mbox_loc']         = Conv2D(num_priors * 4, kernel_size=(3,3),padding='same',name='feat2_mbox_loc')(net['feat2'])
    net['feat2_mbox_loc_flat']    = Flatten(name='feat2_mbox_loc_flat')(net['feat2_mbox_loc'])
    # num_priors表示每个网格点先验框的数量，num_classes是所分的类
    net['feat2_mbox_conf']        = Conv2D(num_priors * num_classes, kernel_size=(3,3),padding='same',name='feat2_mbox_conf')(net['feat2'])
    net['feat2_mbox_conf_flat']   = Flatten(name='feat2_mbox_conf_flat')(net['feat2_mbox_conf'])
    ...
    # 预测框的处理
    # num_priors表示每个网格点先验框的数量，4是x,y,h,w的调整
    net['feat3_mbox_loc']         = Conv2D(num_priors * 4, kernel_size=(3,3), padding='same',name='feat3_mbox_loc')(net['feat3'])
    net['feat3_mbox_loc_flat']    = Flatten(name='feat3_mbox_loc_flat')(net['feat3_mbox_loc'])
    # num_priors表示每个网格点先验框的数量，num_classes是所分的类
    net['feat3_mbox_conf']        = Conv2D(num_priors * num_classes, kernel_size=(3,3), padding='same',name='feat3_mbox_conf')(net['feat3'])
    net['feat3_mbox_conf_flat']   = Flatten(name='feat3_mbox_conf_flat')(net['feat3_mbox_conf'])
    ...
    # 预测框的处理
    # num_priors表示每个网格点先验框的数量，4是x,y,h,w的调整
    net['feat4_mbox_loc']         = Conv2D(num_priors * 4, kernel_size=(3,3), padding='same',name='feat4_mbox_loc')(net['feat4'])
    net['feat4_mbox_loc_flat']    = Flatten(name='feat4_mbox_loc_flat')(net['feat4_mbox_loc'])
    # num_priors表示每个网格点先验框的数量，num_classes是所分的类
    net['feat4_mbox_conf']        = Conv2D(num_priors * num_classes, kernel_size=(3,3), padding='same',name='feat4_mbox_conf')(net['feat4'])
    net['feat4_mbox_conf_flat']   = Flatten(name='feat4_mbox_conf_flat')(net['feat4_mbox_conf'])
    ...
    # 预测框的处理
    # num_priors表示每个网格点先验框的数量，4是x,y,h,w的调整
    net['feat5_mbox_loc']         = Conv2D(num_priors * 4, kernel_size=(3,3), padding='same',name='feat5_mbox_loc')(net['feat5'])
    net['feat5_mbox_loc_flat']    = Flatten(name='feat5_mbox_loc_flat')(net['feat5_mbox_loc'])
    # num_priors表示每个网格点先验框的数量，num_classes是所分的类
    net['feat5_mbox_conf']        = Conv2D(num_priors * num_classes, kernel_size=(3,3), padding='same',name='feat5_mbox_conf')(net['feat5'])
    net['feat5_mbox_conf_flat']   = Flatten(name='feat5_mbox_conf_flat')(net['feat5_mbox_conf'])
    ...
    # 预测框的处理
    # num_priors表示每个网格点先验框的数量，4是x,y,h,w的调整
    net['feat6_mbox_loc']         = Conv2D(num_priors * 4, kernel_size=(3,3), padding='same',name='feat6_mbox_loc')(net['feat6'])
    net['feat6_mbox_loc_flat']    = Flatten(name='feat6_mbox_loc_flat')(net['feat6_mbox_loc'])
    # num_priors表示每个网格点先验框的数量，num_classes是所分的类
    net['feat6_mbox_conf']        = Conv2D(num_priors * num_classes, kernel_size=(3,3), padding='same',name='feat6_mbox_conf')(net['feat6'])
    net['feat6_mbox_conf_flat']   = Flatten(name='feat6_mbox_conf_flat')(net['feat6_mbox_conf'])
    
    # 将所有结果进行堆叠
    net['mbox_loc'] = Concatenate(axis=1, name='mbox_loc')([net['feat1_norm_mbox_loc_flat'],
                                                            net['feat2_mbox_loc_flat'],
                                                            net['feat3_mbox_loc_flat'],
                                                            net['feat4_mbox_loc_flat'],
                                                            net['feat5_mbox_loc_flat'],
                                                            net['feat6_mbox_loc_flat']])
                                    
    net['mbox_conf'] = Concatenate(axis=1, name='mbox_conf')([net['feat1_norm_mbox_conf_flat'],
                                                            net['feat2_mbox_conf_flat'],
                                                            net['feat3_mbox_conf_flat'],
                                                            net['feat4_mbox_conf_flat'],
                                                            net['feat5_mbox_conf_flat'],
                                                            net['feat6_mbox_conf_flat']])
